...
class PubSubMiddlewareTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function it_validates_pub_sub_security_token()
    {
        ...
        $request->shouldReceive('input')->with('token')->andReturn('7RWfH4zxnXXsep5g3LpVxv7xSlnhyFPFeHda87i3Vc');
    ...
    public function it_throws_invalid_pub_sub_security_token_exception()
    {
        ...
        $request->shouldReceive('input')->with('token')->andReturn('herpderp');
...
EOD;
        ...
        $result = $middleware->handle($request, function () { return true; });
